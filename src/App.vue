<template>
  <div id="app">
    <button @click="change(1)">Add1</button>|<button @click="change(0)">
      minus1
    </button>
    ...
    <br />
    <button @click="change1(1)">Add2</button>|<button @click="change1(0)">
      minus2
    </button>
    <p v-for="(item, index) in getStrArr" :key="index + 'a'">{{ item }}</p>
    <br />
    <button @click="change2(1)">Add3</button>|<button @click="change2(0)">
      minus3
    </button>
    <p>{{ getStr }}</p>
